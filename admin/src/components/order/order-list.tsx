...
const OrderList = ({
  ...
  const columns = [
    ...
    },
    {
      ...
      key: 'customer_name',
      align: 'center',
      render: (customer_name: string) => <span>{customer_name}</span>,
    },
    {
      ...
      align: 'center',
      render: (address: string) => <span>{address.street_address}</span>,
    },
    {
      title: t('text-emirate'),
      dataIndex: 'shipping_address',
      key: 'state',
      align: 'center',
      render: (address: string) => <span>{address.state}</span>,
    },
    {
      title: t('text-city'),
      dataIndex: 'shipping_address',
      key: 'city',
      align: 'center',
      render: (address: string) => <span>{address.city}</span>,
    },
    {
