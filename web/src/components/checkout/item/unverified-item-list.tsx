...
const UnverifiedItemList = ({orderData}:any) => {
  const { t } = useTranslation('common');
  const { items, total, isEmpty,totalCommission } = useCart();
    ...
    <div className="w-full">
      ...
      <div className="border border-gray-300 bg-white rounded-md overflow-hidden">
        ...
        <div className="">
          ...
          <ItemInfoRow title={t('text-commission')} value={totalCommission} />
          <ItemInfoRow
            title={t('text-tax')}
        ...
        <div className="px-6 pt-2 pb-6">
          <CheckAvailabilityAction orderData={orderData} >
