...
use Marvel\Database\Repositories\AccountRepository;
...
class AccountController extends CoreController
{
    ...
    {
        return $this->repository->where('customer_id', $request->user()->id)->get();
    }
    ...
    public function store(AccountRequest $request)
    {
        try {
            ...
            return $this->repository->create([...$validatedData, 'customer_id' => $request->user()->id]);
